...
d3.json("data/nodesandlinks.json", function(json) {
    ...
    // add all the links and set their attributes
    ...
    // dictionary to hold a representation of the graph as adjacency lists
    var linkedByIndex = {};
    ...
    // function called to display neighbors on mouseovers.
